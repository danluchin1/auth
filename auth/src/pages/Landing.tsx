    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block">Track your learning</span>
                  <span className="block text-blue-600">with confidence</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Organize your learning resources, track your progress, and achieve your goals with our powerful learning management platform.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-blue-600 sm:h-72 md:h-96 lg:w-full lg:h-full">
            <div className="h-full w-full bg-gradient-to-r from-blue-500 to-blue-600 opacity-90"></div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides all the tools you need to organize and track your learning journey.
            </p>
          </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Organize your learning materials, track progress, and manage your resources efficiently.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Monitor your learning progress, set goals, and celebrate your achievements.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Get insights into your learning patterns and optimize your study strategy.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Personalize your learning experience with customizable categories and tags.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-blue-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-blue-200">
            Join thousands of learners who are already using our platform to achieve their goals.
          </p>
          <Link
            to="/register"
